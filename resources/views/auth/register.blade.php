...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            <p class="mt-2 text-white/60">Bergabung dengan Lunarpedia hari ini</p>
        </div>
        ...
        <div class="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="text-white/50 text-xs mt-1">Password harus minimal 6 karakter</p>
                </div>

                <div>
                    <label for="password_confirmation" class="block text-white/80 text-sm font-medium mb-2">Konfirmasi Password</label>
            ...
            <div class="mt-6 text-center">
                <p class="text-white/60">
                    Sudah punya akun?
                    <a href="{{ route('login') }}" class="text-purple-400 hover:text-purple-300 ml-1 font-semibold">
                        Masuk di sini
                    </a>
                </p>
            </div>
