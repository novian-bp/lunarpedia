/*
  ...
  1. Complete Database Cleanup
    ...
    - Remove all dependencies safely
  ...
  2. New Tables
    ...
    - `user_addons` - Premium add-ons (custom domains, etc.)
...
BEGIN
    ...
    FOR r IN (SELECT schemaname, tablename, triggername FROM pg_triggers WHERE schemaname = 'public') LOOP
...
-- CREATE FUNCTIONS FIRST (before triggers that depend on them)
